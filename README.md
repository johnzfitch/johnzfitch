...
| Project | Description | Stack |
|---------|-------------|-------|
| [**wealth-for-me-not-for-thee**](https://github.com/johnzfitch/wealth-for-me-not-for-thee) | Wealth inequality visualizer - scroll to comprehend billionaire wealth vs median income. | JavaScript, CSS |
