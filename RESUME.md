...
- Inherit All of Nothing. The environment bug in the Codex CLI that I reported in #8945, the runtime code around it, and a recheck of what I later claimed about it against the code and my own probe data. [PDF](https://johnzfitch.github.io/johnzfitch/papers/inherit-all-of-nothing.pdf)
